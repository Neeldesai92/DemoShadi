...
public class Security {
    ...
    public static final String passwordKey = "8080808080808080";
    ...
    private static byte[] getKeyBytes(String key) throws UnsupportedEncodingException {
        ...
        System.arraycopy(parameterKeyBytes, 0, keyBytes,
                0, Math.min(parameterKeyBytes.length, keyBytes.length));
        return keyBytes;
    }
